                    ...
                    <div class="card-body">
                        <form @submit.prevent="updateEmployee">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input v-model="form.first_name" id="first-name" type="text" class="form-control" required autofocus>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input v-model="form.last_name" id="last-name" type="text" class="form-control" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input v-model="form.other_name" id="other-name" type="text" class="form-control" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input v-model="form.zip_code" id="zip-code" type="text" class="form-control" required>
                                </div>
...
export default {
    ...
    methods: {
        ...
        updateEmployee(){
            axios.patch(`/api/employees/${this.$route.params.id}`, {

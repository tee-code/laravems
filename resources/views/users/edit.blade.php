        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                        ...
                        <form
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="role" id="role" class="form-control @error('role') is-invalid @enderror"  required autocomplete="name">
                                        <option class = "bg-primary p-2 mb-3" value="0" disabled>Select Role</option>
                                        @foreach($roles as $role)

                                            <option class = "bg-primary p-2 mb-2 cursor-pointer" value="{{ $role->id }}"
                    ...
                    <div class="card mt-3">
                        <div class="card-header bg-primary text-white">{{ __('Change Password') }}

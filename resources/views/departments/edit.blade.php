    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">{{ __('Update Department') }}
                        <a class="text-white float-right" href="{{ route('departments.index') }}"><i class="fas fa-arrow-left"></i> Back</a>
                    </div>
